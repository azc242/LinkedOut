...
window.onload = function() {
  // var newCoreRail = '<div class="core-rail" role="main"></div>';
  // document.getElementsByClassName("left-rail")[0].insertAdjacentHTML("afterend", newCoreRail);
...
//     var imgEmbed = header1 + imageHeader + img + imageHeader2 + header2;
//
//     var coreRailHtml = document.getElementByClassName("core-rail");
//     coreRailHtml.innerHTML = imgEmbed;
//     console.log(coreRailHtml);
//   } catch (e) {
